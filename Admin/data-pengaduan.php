        ...
        while($d = mysqli_fetch_array($data)){
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <a class="mr-2" href="edit.php?id=<?php echo $d['id_pengaduan']; ?>"><i class="ti-pencil-alt">Edit</i></a>
                        <a href="hapus.php?id=<?php echo $d['id_pengaduan']; ?>"><i class="ti-eraser">Hapus</i></a>
                    </td>
                </tr>
            </tbody>
            <?php 
